...
const handler = async (
  m,
  { conn, isOwner, usedPrefix, text, command, args },
) => {
  if (!text)
    throw (
...
function userRecommendedArtists(username) {
  return (
    apiUrl +
    "?method=user.getRecommendedArtists&user=" +
    username +
    "&api_key=" +
    apiKey +
    "&format=json"
...
function trackTopFan(artist, trackName) {
  return (
    apiUrl +
    "?method=track.gettopfans&artist=" +
    artist +
    "&track=" +
    trackName +
    "&api_key=" +
...
function compareUserTaste(user1, user2) {
  return (
    apiUrl +
    "?method=tasteometer.compare&type1=user&type2=user&value1=" +
    user1 +
    "&value2=" +
    user2 +
    "&api_key=" +
...
function compareUserToArtist(artist, user) {
  return (
    apiUrl +
    "?method=tasteometer.compare&type1=artists&type2=user&value1=" +
    artist +
    "&value2=" +
    user +
    "&api_key=" +
...
function libraryTracks(user) {
  return (
    apiUrl +
    "?method=library.gettracks&api_key=" +
    apiKey +
    "&user=" +
    user +
    "&format=json"
...
function libraryArtist(user) {
  return (
    apiUrl +
    "?method=library.getartist&api_key=" +
    apiKey +
    "&user=" +
    user +
    "&format=json"
...
function libraryAlbum(user) {
  return (
    apiUrl +
    "?method=library.getalbums&api_key=" +
    apiKey +
    "&user=" +
    user +
    "&format=json"
...
function metroHypeTrackChart(metro, country) {
  return (
    apiUrl +
    "?method=geo.getmetrohypetrackchart&country=" +
    country +
    "&metro=" +
    metro +
    "&api_key=" +
...
function metroArtistChart(metro, country) {
  return (
    apiUrl +
    "?method=geo.getmetroartistchart&country=" +
    country +
    "&metro=" +
    metro +
    "&api_key=" +
...
function metroTrackChart(metro, country) {
  return (
    apiUrl +
    "?method=geo.getmetrotrackchart&country=" +
    country +
    "&metro=" +
    metro +
    "&api_key=" +
...
function eventAttendes(eventId) {
  return (
    apiUrl +
    "?method=event.getattendees&event=" +
    eventId +
    "&api_key=" +
    apiKey +
    "=json"
...
function artistTopFans(artist) {
  return (
    apiUrl +
    "?method=artist.gettopfans&artist=" +
    artist +
    "&api_key=" +
    apiKey +
    "&format=json"
...
function artistEvents(artist) {
  return (
    apiUrl +
    "?method=artist.getevents&artist=" +
    artist +
    "&api_key=" +
    apiKey +
    "&format=json"
