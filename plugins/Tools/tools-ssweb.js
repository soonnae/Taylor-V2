...
const services = [
  ...
  },
  {
    name: "Thum.io",
    key: "v3",
    apiKey: process.env.THUMIO_API_KEY || "",
  },
  {
    name: "MiniScreenshot",
    key: "v4",
    apiKey: process.env.MINISCREENSHOT_API_KEY || "",
  },
  {
    name: "ScreenshotMachine",
    key: "v5",
    apiKey: process.env.SCREENSHOTMACHINE_API_KEY || "",
  },
  {
    name: "Pikwy",
    key: "v6",
    apiKey: process.env.PIKWY_API_KEY || "",
  },
  {
    name: "Tools.SSWeb",
    key: "v7",
    apiKey: process.env.TOOLS_SS_WEB_API_KEY || "",
  },
  {
    name: "2s9e3bif",
    key: "v8",
    apiKey: process.env.TWOS9E3BIF_API_KEY || "",
  },
  {
    name: "Hexometer",
    key: "v9",
    apiKey: process.env.HEXOMETER_API_KEY || "",
  },
  {
    name: "GoogleApis",
    key: "v10",
    apiKey: process.env.GOOGLEAPIS_API_KEY || "",
  },
  {
    name: "ElzinkoWebshot",
    key: "v11",
    apiKey: process.env.ELZINKOWEBSHOT_API_KEY || "",
  },
  {
  ...
  },
  {
    name: "Terasp.net",
    key: "v15",
    apiKey: process.env.TERASP_NET_API_KEY || "",
  },
  {
    name: "ShotSnap",
    key: "v16",
    apiKey: process.env.SHOTSNAP_API_KEY || "",
  },
  {
    name: "Pptr.io",
    key: "v17",
    apiKey: process.env.PPTR_IO_API_KEY || "",
  },
];
